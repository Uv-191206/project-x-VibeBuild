...
import { MessageCircle, X, Send, Bot, Sparkles, Github, Rocket, ArrowLeft, ChevronRight } from 'lucide-react';
...
export default function ChatBot() {
    ...
    async function handleSend() {
        ...
        if (q.includes('github') || q.includes('repo')) {
            ...
            setGuideStep(0);
        } else if (q.includes('vercel') || q.includes('deploy')) {
            ...
            setMessages(prev => [...prev, { role: 'assistant', content: 'I only handle static queries regarding GitHub and Vercel deployments! Try asking about them.' }]);
        }
        setLoading(false);
    }
